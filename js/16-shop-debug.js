...
(function () {
  ...
  var SHOP_FLAVOR_TEXTS = [
    "001. くろ手裏剣。基本の手裏剣。まずはこれから。。投げる前提の軽さがあり、狙いの精度がそのまま扱いやすさになる。最初の一歩にちょうどいい。",
    "002. 棒手裏剣。直線的に飛ばす、扱いやすい入門武器。。投げる前提の軽さがあり、狙いの精度がそのまま扱いやすさになる。最初の一歩にちょうどいい。",
    "003. 苦無。掘る・はさむ・刺す、万能寄り。。刺すだけでなく、引っ掛ける、こじ開ける、支える場面でも役に立つ。最初の一歩にちょうどいい。",
    "004. まきびし。追手の足止めに使う。逃走向き。。忍びの仕事を、地味に確実に押し上げてくれる。最初の一歩にちょうどいい。",
    "005. 火打石。火起こし用。野営・合図にも。。一手で場の空気を変えられる、作戦の起点になる品だ。最初の一歩にちょうどいい。",
    "006. 手ぬぐい。隠す・拭く・縛る、地味に便利。。忍びの仕事を、地味に確実に押し上げてくれる。最初の一歩にちょうどいい。",
    "007. 編笠。顔を隠して街に溶け込む。。忍びの仕事を、地味に確実に押し上げてくれる。最初の一歩にちょうどいい。",
    "008. 草鞋。素早い移動用の基本装備。。足音を抑えつつ、地面の感触を拾いやすいのが魅力だ。最初の一歩にちょうどいい。",
    "009. 忍び袋。道具をまとめて持ち歩ける。。小物を整えて持ち歩けるので、準備の乱れを減らしてくれる。最初の一歩にちょうどいい。",
    ...
    "015. 忍び面。正体を見せないための面。。表情を隠すことで、視線の向きをそらす効果が強い。最初の一歩にちょうどいい。",
    "016. 小太刀。近接戦の軽量武器。。近い距離で素早く扱える、携帯性の高さが魅力だ。手に入れると行動の幅がひとつ広がる。",
    "017. 竹手裏剣。竹製で軽く、練習用にも向く。。投げる前提の軽さがあり、狙いの精度がそのまま扱いやすさになる。手に入れると行動の幅がひとつ広がる。",
    ...
    "021. 鉤縄。壁・塀・高所へ移動するための道具。。届かない場所へ手を伸ばすための、忍びらしい実務の道具だ。手に入れると行動の幅がひとつ広がる。",
    ...
    "024. 忍び刀。携帯性重視の短い刀。。忍びの仕事を、地味に確実に押し上げてくれる。手に入れると行動の幅がひとつ広がる。",
    ...
    "027. 手甲鉤。引っ掛ける・奪う・登るの三役。。忍びの仕事を、地味に確実に押し上げてくれる。手に入れると行動の幅がひとつ広がる。",
    "028. 鎖帷子。軽装ながら防御力の高い防具。。つなぐ・払う・絡めるの切り替えができ、間合いの読み合いに強い。手に入れると行動の幅がひとつ広がる。",
    "029. 胸当て。飛び道具対策の防具。。守りを足しつつ、動きを殺しすぎないのが忍び向きだ。手に入れると行動の幅がひとつ広がる。",
    ...
    "039. 小型提灯。闇での足元確認に便利。。忍びの仕事を、地味に確実に押し上げてくれる。手に入れると行動の幅がひとつ広がる。",
    "040. 夜目鏡。暗所でも見やすくするファンタジー装備。。視界の制約を越える、頼もしさを感じさせる上位装備だ。手に入れると行動の幅がひとつ広がる。",
    "041. 竹鉤縄。軽い竹芯を使った静音仕様の鉤縄。。届かない場所へ手を伸ばすための、忍びらしい実務の道具だ。手に入れると行動の幅がひとつ広がる。",
    ...
    "048. 忍び舟。水路の移動や密かな移送に。。水面を越えるとき、音を立てずに運べるかがこの品の持ち味だ。中盤以降の頼もしさがあり、道具箱の主役になっていく。",
    "049. 忍者甲冑。防御を重視した実戦向け装備。。守りを足しつつ、動きを殺しすぎないのが忍び向きだ。中盤以降の頼もしさがあり、道具箱の主役になっていく。",
    "050. 忍び外套。風景に溶け込む大きな外套。。身にまとうだけで輪郭が変わり、存在感を静かに薄めてくれる。中盤以降の頼もしさがあり、道具箱の主役になっていく。",
    "051. 鉄甲船模型。作戦立案用の小型見本。。忍びの仕事を、地味に確実に押し上げてくれる。中盤以降の頼もしさがあり、道具箱の主役になっていく。",
    "052. 大鉤縄。長距離を狙える強化型。。届かない場所へ手を伸ばすための、忍びらしい実務の道具だ。中盤以降の頼もしさがあり、道具箱の主役になっていく。",
    "053. 大鎖鎌。より長い間合いを取れる大型鎖鎌。。つなぐ・払う・絡めるの切り替えができ、間合いの読み合いに強い。中盤以降の頼もしさがあり、道具箱の主役になっていく。",
    "054. 忍術秘伝書。忍術の基本をまとめた宝典。。紙の中に技と記憶を閉じ込めた、知識そのものの品だ。中盤以降の頼もしさがあり、道具箱の主役になっていく。",
    ...
    "063. 黒漆忍び舟。目立たない黒漆仕上げの忍び舟。。水面を越えるとき、音を立てずに運べるかがこの品の持ち味だ。中盤以降の頼もしさがあり、道具箱の主役になっていく。",
    "064. 軽甲冑。軽さと防御のバランスを取った鎧。。守りを足しつつ、動きを殺しすぎないのが忍び向きだ。中盤以降の頼もしさがあり、道具箱の主役になっていく。",
    "065. 影外套。影に沈むような深色の外套。。身にまとうだけで輪郭が変わり、存在感を静かに薄めてくれる。中盤以降の頼もしさがあり、道具箱の主役になっていく。",
    "066. 黄金手裏剣。ご褒美の定番。輝きで圧倒する。。投げる前提の軽さがあり、狙いの精度がそのまま扱いやすさになる。中盤以降の頼もしさがあり、道具箱の主役になっていく。",
    ...
    "070. 雷神の鉤縄。速さを感じさせる伝説の鉤縄。。届かない場所へ手を伸ばすための、忍びらしい実務の道具だ。中盤以降の頼もしさがあり、道具箱の主役になっていく。",
    ...
    "075. 忍術大全。忍術を一冊に集めた大宝典。。忍びの仕事を、地味に確実に押し上げてくれる。終盤にふさわしい、集めること自体が勲章になる。",
    "076. 金剛手裏剣。さらに硬く磨き上げた黄金級。。投げる前提の軽さがあり、狙いの精度がそのまま扱いやすさになる。終盤にふさわしい、集めること自体が勲章になる。",
    "077. 霜刃苦無。触れる手を冷たくする氷の苦無。。刺すだけでなく、引っ掛ける、こじ開ける、支える場面でも役に立つ。終盤にふさわしい、集めること自体が勲章になる。",
    "078. 天雷の鉤縄。雷鳴のように伸びる上位鉤縄。。届かない場所へ手を伸ばすための、忍びらしい実務の道具だ。終盤にふさわしい、集めること自体が勲章になる。",
    ...
    "085. 忍術大全・極。忍術大全の最終版。。忍びの仕事を、地味に確実に押し上げてくれる。終盤にふさわしい、集めること自体が勲章になる。",
    ...
    "088. 忍術皆伝の証。全基礎を修めた証。。使う道具ではなく、歩んだ道の深さを示す勲章として輝く。中盤以降の頼もしさがあり、道具箱の主役になっていく。",
    ...
    "093. 忍術皆伝の証・金。皆伝の到達を祝う金札。。使う道具ではなく、歩んだ道の深さを示す勲章として輝く。終盤にふさわしい、集めること自体が勲章になる。",
    ...
    "098. 忍具蒐集家の証。忍具を集め尽くした者の勲章。。使う道具ではなく、歩んだ道の深さを示す勲章として輝く。終盤にふさわしい、集めること自体が勲章になる。",
  ...
  function buildShopFlavor(item, index) {
    ...
    if (!base) {
      base = '第' + (index + 1) + '番の忍具。' + name + 'は' + desc + '。';
    }
